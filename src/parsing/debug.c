...
/*   Updated: 2025/08/21 17:23:03 by yabokhar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	debug_display_scene_param(t_context *scene)
{
	...
	printf("\n\nLight :\nBrightness ratio : %s%f%s\nPosition : ", FG_RED, scene->lights.brightness_ratio, RESET);
	print_vect(&scene->lights.light_point);
	printf("\nColor : RGB : %s%d, %d, %d%s\n\n", FG_RED, scene->lights.color.r, scene->lights.color.g, scene->lights.color.b, RESET);
	printf("Obj : \n\n");
